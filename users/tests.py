...
#        call_command('loaddata', 'test_db.json')
        ...
        self.superuser = User.objects.create_superuser('django2', 'django2@geekshop.local', 'Geekbrains123')

        self.user = User.objects.create_user('tarantino', 'tarantino@geekshop.local', 'Geekbrains123')

        self.user_with__first_name = User.objects.create_user('umaturman', 'umaturman@geekshop.local',
                                                              'Geekbrains123', first_name='Ума')
    ...
    def test_user_login(self):
        ...
        self.client.login(username='tarantino', password='Geekbrains123')
        ...
        response = self.client.get('/')
        self.assertContains(response, 'GeekShop', status_code=200)
        self.assertEqual(response.context['user'], self.user)
